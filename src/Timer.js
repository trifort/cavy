...
(function (window) {
	 ...
	 * @alias cavy.Timer
	 * @example
	 *  var t = Timer.repeat(function(){},1000);    //1000ms毎に繰り返し
	 *  Timer.stop(t);    //タイマー停止
	 *  Timer.repeat(function(){});    //フレーム毎に繰り返し
	 *  Timer.repeat(function(){},1000,3);    //1000ms毎に３回繰り返し
	 *  Timer.delay(function(){},0,3);    //フレーム毎に３回繰り返し
	 **/
	var Timer = function () {
		this.isTick = false;
		this.repeats = [];
