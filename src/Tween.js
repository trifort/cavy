...
(function (window) {
	 ...
	 * @return {TweenObject}
	 * @example
	 *  var t = Tween.create(sprite).to({x:100,y:100});
	 **/
	 ...
	 * @return {TweenObject}
	 * @example
	 *  var t = Tween.create(sprite).set({x:100,y:100});
	 **/
	 ...
	 * @return {TweenObject}
	 * @example
	 *  var t = Tween.create(sprite).wait(1000).to({x:100,y:100});
	 **/
	 ...
	 * @return {TweenObject}
	 * @example
	 *  var t = Tween.create(sprite).wait(1000).call(function(){alert("hoge")});
	 **/
	 ...
	 * @example
	 *  var t = Tween.create(sprite).to({x:100,y:100}).complete(function(){});
	 **/
	 ...
	 * @return {TweenObject}
	 * @example
	 *  var t = Tween.create(sprite).to({x:100,y:100}).repeat();
	 **/
	...
	ParamQueue.prototype = {
		...
		QUEUE_TYPE: "param",
		initialize: function (sprite, reverse) {
			this.count = this.frame = 0;
